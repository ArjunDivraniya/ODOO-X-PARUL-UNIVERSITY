...
import { createExpense } from '../../../api/tripTabs';
...
const CreateExpenseModal = ({ isOpen, onClose, tripId, onCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onCreated(res.data.data.expense);
          ...
          >
            <div className="bg-[#0A1622] border border-white/10 rounded-[32px] shadow-2xl w-full max-w-xl">
              <div className="flex items-center justify-between p-8 pb-4 border-b border-white/5">
                <h2 className="text-2xl font-heading font-bold text-secondary-bg">Add Expense</h2>
