...
import { updateTripSection } from '../../../api/tripTabs';
...
const EditSectionModal = ({ isOpen, onClose, section, onUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await updateTripSection(section.id, payload);
      onUpdated(res.data.data.section);
          ...
          >
            <div className="bg-[#0A1622] border border-white/10 rounded-[32px] shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between p-8 pb-4 border-b border-white/5">
                <h2 className="text-2xl font-heading font-bold text-secondary-bg">Edit Section</h2>
