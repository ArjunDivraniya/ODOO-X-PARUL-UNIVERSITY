...
import { createActivity } from '../../../api/tripTabs';
...
const CreateActivityModal = ({ isOpen, onClose, tripId, sections, onCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fallbackDate = selectedSection?.startDate || selectedSection?.endDate;
      const payload = {
        tripId,
      ...
      onCreated(res.data.data.activity);
          ...
          >
            <div className="bg-[#0A1622] border border-white/10 rounded-[32px] shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
              <div className="flex items-center justify-between p-8 pb-4 border-b border-white/5">
                <h2 className="text-2xl font-heading font-bold text-secondary-bg">Add Activity</h2>
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="activityType" name="activityType" value={formData.activityType} onChange={handleChange} placeholder="Tour, Reservation, etc" />
                  </div>
                </div>
